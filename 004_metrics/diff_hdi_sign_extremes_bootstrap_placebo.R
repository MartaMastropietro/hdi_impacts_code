...
for (form in formulations){
  for (ext in extr_variables){
    ...
    if (form == "burke_extr_sq"){ 
      ...
      write.csv(rand_coefs_nonrand,file.path(out_dir,paste0(ext, "_",form, "_coefs_randomization_nonrandom.csv")))
      write.csv(rand_coefs_overall,file.path(out_dir,paste0(ext,"_",form,"_coefs_randomization_fullsample.csv")))
      write.csv(rand_coefs_withinyear,file.path(out_dir,paste0(ext,"_",form,"_coefs_randomization_withinyear.csv")))
      write.csv(rand_coefs_withinregion,file.path(out_dir,paste0(ext,"_",form,"_coefs_randomization_withinregion.csv")))
