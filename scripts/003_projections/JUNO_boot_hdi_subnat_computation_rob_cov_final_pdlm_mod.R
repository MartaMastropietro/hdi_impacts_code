...
### try
o<-"gr_gnipc"
data_int_gnipc<-arrow::read_feather(file.path(out_dir_lag,paste0(o,'_',spec,'_',vars, "_pop_weight_nlags",N,"_boot_impacts_rob_cov_intervals.feather")))
# to uncomment
data_all_gnipc<-arrow::read_feather(file.path(out_dir_lag,paste0(o,'_',spec,'_',vars, "_pop_weight_nlags",N,"_boot_impacts_rob_cov_all.feather")))
data_int_gnipc<-inner_join(data_int_gnipc, pop_projection_gdlcode )
gc()
o<-"gr_leb"
data_int_leb<-arrow::read_feather(file.path(out_dir_lag,paste0(o,'_',spec,'_',vars, "_pop_weight_nlags",N,"_boot_impacts_rob_cov_intervals.feather")))
# to uncomment
data_all_leb<-arrow::read_feather(file.path(out_dir_lag,paste0(o,'_',spec,'_',vars, "_pop_weight_nlags",N,"_boot_impacts_rob_cov_all.feather")))
data_int_leb<-inner_join(data_int_leb, pop_projection_gdlcode )
gc()
o<-"gr_eys"
data_int_eys<-arrow::read_feather(file.path(out_dir_lag,paste0(o,'_',spec,'_',vars, "_pop_weight_nlags",N,"_boot_impacts_rob_cov_intervals.feather")))
# to uncomment
data_all_eys<-arrow::read_feather(file.path(out_dir_lag,paste0(o,'_',spec,'_',vars, "_pop_weight_nlags",N,"_boot_impacts_rob_cov_all.feather")))
