...
### climate data 
climate_projections<- arrow::read_feather(file.path(out_dir, "climate_projections_country_area_weight.feather"))
...
### save 
library(arrow)
arrow::write_feather(climate_projections, file.path(out_dir, "climate_projections_country_area_weight_llgnipc_llgdppc.feather"))
