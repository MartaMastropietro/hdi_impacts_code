...
climate_projections_big<-read_csv(file.path(data_cl_dir, "projection_data_climate_gdlcode_2015_2100.csv"))
...
for (r in regions[890:length(regions)]){
  ...
  save(climate_projections, file=file.path(out_dir,paste0(r,"_climate_projections_gdl_area_weight.RData")))
  pb$tick()
}
