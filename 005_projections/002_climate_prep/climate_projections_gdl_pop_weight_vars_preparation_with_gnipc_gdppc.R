...
# load(file.path(out_dir, "climate_projections_pop_weight.RData"))
...
for ( r in regions){
  ...
  load(file.path(out_dir,paste0(r,"_climate_projections_gdl_pop_weight.RData"))) 
  climate_projections<-as.data.frame(climate_projections)
  ...
  # save
  save(climate_projections, file=file.path(out_dir,paste0(r,"_climate_projections_gdl_pop_weight_llgni_llgdp.RData")))
  pb$tick()
