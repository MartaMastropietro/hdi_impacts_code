...
### historical climate
data_cl_hist<- read_csv("data/climate_data/era5/data_climate_country_1950_2023_updated.csv")
...
data_cl_dir<-"data/climate_data/projections"
climate_projections<-read_csv(file.path(data_cl_dir, "projection_data_climate_country_2015_2100.csv"))
...
### save 
library(arrow)
arrow::write_feather(climate_projections, file.path(out_dir, "climate_projections_country_area_weight.feather"))
